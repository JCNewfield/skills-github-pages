...
{
  /// ***********************************************************
  public partial class EditProduct : ContentPageBase
  {
    private DbProduct _thisProduct;
    ...
    {
      var _ProductID = this.Ets.Values["ProductID"];
      string productString2 = _ProductID.ToString();
      int productInteger2 = Int32.Parse(productString2);
      this._thisProduct = Ets.Api.Data.DbProduct.Load.ByID(productInteger2);
      this.Ets.Values["Model.Name"] = this._thisProduct.Name;
      this.Ets.Values["Model.ProductCode"] = this._thisProduct.ProductCode;
      this.Ets.Values["Model.StandardSize"] = this._thisProduct.StandardSize;
      this.Ets.Values["Model.ProductTypeID"] = this._thisProduct.ProductTypeID;
      this.Ets.Values["Model.ProductSetID"] = this._thisProduct.ProductSetID;
      this.Ets.Values["Model.StandardUnits"] = this._thisProduct.StandardUnits;
      //this.Ets.Values["Model.ProductMaterial"] = this._thisProduct.ProducedMaterialID;
    ...
    {
      _thisProduct.Name = this.Ets.Form.GetValueAsStringByKey("Model.Name");
      _thisProduct.ProductCode = this.Ets.Form.GetValueAsStringByKey("Model.ProductCode");
      _thisProduct.StandardSize = this.Ets.Form.GetValueAsIntByKey("Model.StandardSize");
      _thisProduct.ProductTypeID = this.Ets.Form.GetValueAsIntByKey("Model.ProductTypeID");
      _thisProduct.ProductSetID = this.Ets.Form.GetValueAsIntByKey("Model.ProductSetID");
      _thisProduct.StandardUnits = this.Ets.Form.GetValueAsStringByKey("Model.StandardUnits");
    ...
    private void Edit(object sender, EventArgs e)
    {
      ...
      var _product = this.Ets.Values["ProductID"];
      ...
      string productString = _product.ToString();
      int productInteger = Int32.Parse(productString);
      // Create a model object to populate
      ETS.Core.Api.Models.Data.DbProduct product = api.Data.DbProduct.Load.ByID(productInteger);
      ...
      var url = "http://10.19.10.4/TS/pages/home/adminconfig/manageproductstorage/";
    ...
    private void Add(object sender, EventArgs e)
    {
      ...
      // Here we insert the entity in the database (The ID will be created when inserted to the database)
      result = api.Data.DbProduct.Save.InsertAsNew(product);
