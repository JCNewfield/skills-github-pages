...
{
  /// ***********************************************************
  public partial class SalesOrderOverview : ContentPageBase
  {
    ...
    {
if (string.IsNullOrEmpty(this.Ets.Values.GetAsString("Data.Orders.Selected.StartDateTime")))
{
    this.Ets.Values["Tab"] = false;
}
